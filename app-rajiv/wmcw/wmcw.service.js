...
angular.module('wmcw')
.factory('wmcwFormFactory',['$log', '$http', '$httpParamSerializer',
	function ($log, $http, $httpParamSerializer) {
		return {
			GetWmcwAttribute: function (param, callback) {
				console.log("GetWmcwAttribute");
				...
				//	url: "http://142.4.215.210:11080/api/attribute",
					...
					console.error("Error:wmcwFormFactory-GetSearchAttribute");				
					callback(response);
				});
			},
/*			
